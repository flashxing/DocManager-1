...
var count=0;
function selectAccount(str)
{  
var list="${requestScope.metaMaps}";
var list0=list.split(" {");
alert(list0);
		...
		<div class="post">
			...
			<p>&nbsp;</p>		
              <p>
                    ...
                    <select name="type" id="select" onchange="selectAccount(this.value)">
                    <option selected="selected">类型</option>
                      <s:iterator id="tmp" value="typeList">
                      <option value="<s:property value="#tmp"/>"><s:property value="#tmp"/></option>
                      </s:iterator>
                    </select>
                </p>
