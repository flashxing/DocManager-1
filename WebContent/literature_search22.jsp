	...
	<div id="content">
		<div class="post">
			...
			<div class="entry">
                ...
                <form id="form1" method="post" action="search.action">
                <p style="height:30px;vertical-align:top"> 发表时间:从<input type="text" style="height:25px;margin:0 0 0 18px" name="startTime"/>  到  <input style="height:25px" type="text" name="endTime"/>               
                </p>
                <p style="height:30px;vertical-align:top">文献来源:<input style="height:25px;margin:0 0 0 34px" type="text" name="title"/></p>
                <p style="height:30px;vertical-align:top">摘要:<input style="height:25px;margin:0 0 0 65px" type="text" name="author"/></p>
                <p style="height:30px;vertical-align:top">关键词:<input style="height:25px;margin:0 0 0 48px" type="text" name="key"/></p>
                <p style="height:30px;vertical-align:top">包含全部字词:<input style="height:25px" type="text" name="sentence"/></p>
                <p style="height:30px;vertical-align:top">包含完整字句:<input style="height:25px" type="text" name="word"/></p>
                  <p>
                    ...
                    <label for="search">
                      <input name="search"  style="height:28px"type="text" id="search-text1" value="" />
                    </label>      
                  </p>
