...
<html>
  ...
  <form action="docAdd.action" method="post"  enctype="multipart/form-data">
                <div><input type="hidden" class="eg0" name="type" value="会议"  /></div>   
                <div><div class="eg">DOI</div> <input type="text"  class="eg0" name="DOI"/></div>
                ...
                <div><div class="eg">会议年份</div> <input type="text"  class="eg0" name="conferenceYear"/></div>
                <div><div class="eg">会议所在城市</div> <input type="text"  class="eg0" name="conferenceCity"/></div>
                <div><div class="eg">摘要</div> <input type="text"  class="eg0" name="docAbstract"/></div>
