...
<html>
  ...
  <form action="docAdd.action" method="post"  enctype="multipart/form-data">
                <div><input type="hidden" class="eg0" name="type" value="图书章节"  /></div>   
                ...
                <div><div class="eg">图书名</div> <input type="text" class="eg0" name="bookName"/></div>
                
                <div><div class="eg">出版社</div> <input type="text"  class="eg0" name="publisher"/></div>
                <div><div class="eg">编辑</div> <textarea rows="3" cols="20"  class="eg2" name="editor"></textarea></div>
