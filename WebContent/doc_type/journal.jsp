...
<html>
  ...
  <form action="docAdd.action" method="post"  enctype="multipart/form-data">
                <div><input type="hidden" class="eg0" name="type" value="期刊" /></div>   
                ...
                <div><div class="eg">卷</div> <input type="text"  class="eg0" name="volume"/></div>
                <div><div class="eg">期</div> <input type="text"  class="eg0" name="issue"/></div>
