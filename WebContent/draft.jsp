...
<script src="http://www.see-source.com/bootstrap/js/bootstrap-tab.js"  type="text/javascript"></script>
  <script>
    ...
    //  "aaa.do?str="+str+"&str2="+str2+"&str3="str3
      ...
      document.briefform.action="updateBrief.action?assessId=<s:property value="assess.assessId"/>"+"&bod="+bod;
...
<div id="page">
  ...
  <input type="radio" name="radio1" id="rank10" value=5 />
               ...
               <div>
              <div class="eg">你的简要评价：</div>      
             <textarea name="briefAssess" id="briefAssess" cols="60" rows="3" >${assess.briefAssess}</textarea>
                </div>
                  <p  class="date4">
