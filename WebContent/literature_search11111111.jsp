...
function addRow() {
 ...
 cell = row.insertCell();
 cell.innerHTML = " <p><select name='select' id='select' ><option selected='selected' >全文</option>"
                      +"<option>标题</option>"
                      +"<option>作者</option>"
                      +"<option>出版年份</option>"
                      +"<option>关键词</option>"
                      ...
                      +"<option>出版年份</option>"
                    +"</select>"  
                   +"<input name='search' style='height:24px;vertical-align:text-bottom;margin:0 0 0 5px' type='text'/>"; 
}
</script>
</head>
<body>
	...
	<div id="content">
		<div class="post">
			...
			<td>  <p>
                   ...
                   <input name="search" style="height:24px;vertical-align:text-bottom" type="text"  value="" />
